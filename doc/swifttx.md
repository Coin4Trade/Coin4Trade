...
This mechanism has been integrated into Bitcore-Node-C4T which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Coin4Trade/insight-api-C4T#web-socket-api](https://github.com/Coin4Trade/insight-api-C4T#web-socket-api) 
* API: [https://github.com/Coin4Trade/insight-api-C4T#swifttx-transactions](https://github.com/Coin4Trade/insight-api-C4T#swifttx-transactions) 
...
By default, the C4T Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the C4T Core daemon:
