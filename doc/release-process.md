...
### Build and sign C4T Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit C4T=v${VERSION} ../C4T/contrib/gitian-descriptors/gitian-osx.yml
...
- Detached signatures will then be committed to the [C4T-detached-sigs](https://github.com/Coin4Trade/C4T-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/Coin4Trade/C4T/releases/new) with a link to the archived release notes.
