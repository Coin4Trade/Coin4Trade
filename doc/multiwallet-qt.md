...
In order to support loading of multiple wallets in C4T-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is C4T.cpp.
...
Changes to C4T.cpp
----------------------
C4T.cpp is the entry point into C4T-qt, and as such, will require some minor modifications to provide hooks for
