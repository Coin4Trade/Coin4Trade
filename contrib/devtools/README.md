...
Setup
---------
Configuring the github-merge tool for the C4T repository is done in the following way:

    git config githubmerge.repository C4T/C4T
...
A script to optimize png files in the C4T
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_C4T: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_C4T: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_C4T: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_C4T: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
