...
RESOURCES += src/qt/C4T.qrc src/qt/C4T_locale.qrc

TRANSLATIONS += src/qt/locale/C4T_bg.ts \
                src/qt/locale/C4T_de.ts \
                src/qt/locale/C4T_en.ts \
                src/qt/locale/C4T_es.ts \
                src/qt/locale/C4T_fi.ts \
                src/qt/locale/C4T_fr.ts \
                src/qt/locale/C4T_it.ts \
                src/qt/locale/C4T_ja.ts \
                src/qt/locale/C4T_pl.ts \
                src/qt/locale/C4T_pt.ts \
                src/qt/locale/C4T_ru.ts \
                src/qt/locale/C4T_sk.ts \
                src/qt/locale/C4T_sv.ts \
                src/qt/locale/C4T_vi.ts \
                src/qt/locale/C4T_zh_CN.ts \
                src/qt/locale/C4T_zh_TW.ts
