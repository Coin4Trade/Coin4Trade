...
#   c) node1 mines 32 blocks, so now node 0 has 60001C4T, node 1 has 4250C4T, node2 has none.
#   d) node0 sends 601 C4T to node2, in two transactions (301 C4T, then 300 C4T).
