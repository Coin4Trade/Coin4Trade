Contributing to C4T Core
============================

The C4T Core project operates an open contributor model where anyone is
...
The following applies to code changes to the C4T Core project, and is not to be
confused with overall C4T Network Protocol consensus changes.

Whether a pull request is merged into C4T Core rests with the project merge
...
Patches that change C4T consensus rules are considerably more involved than
...
Where a patch set proposes to change the C4T consensus, it must have been
...
The project leader is the release manager for each C4T Core release.
