...
#ifndef C4T_ZC4TWALLET_H
#define C4T_ZC4TWALLET_H
...
public:
    CzC4TWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZC4T(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZC4T(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //C4T_ZC4TWALLET_H
