...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("C4T Core C4T-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  C4T-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded C4T transaction") + "\n" +
                               "  C4T-tx [options] -create [commands]   " + _("Create hex-encoded C4T transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded C4T transaction
