...
/* C4T GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "C4T"
#define QAPP_ORG_DOMAIN "C4T.org"
#define QAPP_APP_NAME_DEFAULT "C4T-Qt"
#define QAPP_APP_NAME_TESTNET "C4T-Qt-testnet"
