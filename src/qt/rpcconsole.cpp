...
// Copyright (c) 2015-2018 The C4T developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzC4TPathCustom = GetArg("-zC4Tbackuppath", "");
    ...
    if(!strzC4TPathCustom.empty()) {
        ui->wallet_customzC4Tbackuppath->setText(QString::fromStdString(strzC4TPathCustom));
        ui->wallet_customzC4Tbackuppath_label->setVisible(true);
        ui->wallet_customzC4Tbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzC4TPathCustom.empty()) && nCustomBackupThreshold > 0) {
