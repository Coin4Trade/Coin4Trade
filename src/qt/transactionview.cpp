                                                    ...
                                                    transactionView(0)
{
    ...
    */
    ...
    /*
	typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZC4T));
    */
	typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    /*
	typeWidget->addItem(tr("Received C4T from zC4T"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zC4T"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zC4T));
